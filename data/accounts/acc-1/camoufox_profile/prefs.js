...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1777534372);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1777553990);
user_pref("app.update.lastUpdateTime.region-update-timer", 1777096044);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1777534372);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1777096075);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 1777537972);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1777534372);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{1424dc5a-ec6c-4da9-95c6-508170f1c03d}");
...
user_pref("browser.startup.lastColdStartupCheck", 1777546830);
...
user_pref("captchadetection.lastSubmission", 1777096);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIf/dEHqwIuSBAjymFw/dY13KA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"401129f1-1e09-4144-bdf8-0c41513598c5\",\"pictureinpicture@mozilla.org\":\"714312a1-cabe-4400-a1f5-853aa885c7d5\",\"screenshots@mozilla.org\":\"710b8d7c-a3dd-42d1-8ee0-1c6759665d51\",\"webcompat@mozilla.org\":\"3fb1c3bb-24ec-406c-8008-5c081b68ffc3\",\"firefox-compact-dark@mozilla.org\":\"a58accfe-f4bc-4f0b-89cc-5e3d2f3a251e\",\"addons-search-detection@mozilla.com\":\"441f23f2-97e4-45fb-8d5c-ef29a7d7d671\",\"uBlock0@raymondhill.net\":\"06de45ac-f070-4640-be26-5b400d76eacd\"}");
...
user_pref("idle.lastDailyNotification", 1777534741);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECGv8ns8g1yGEBAgwKZYO29YzvQ==");
user_pref("storage.vacuum.last.content-prefs.sqlite", 1777362178);
user_pref("storage.vacuum.last.index", 2);
user_pref("storage.vacuum.last.places.sqlite", 1777275777);
user_pref("toolkit.startup.last_success", 1777546826);
