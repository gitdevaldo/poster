...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1774370291);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1774375549);
user_pref("app.update.lastUpdateTime.region-update-timer", 1774370291);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1774370291);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1774370321);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1774370291);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{a0b9a14f-5f36-45b3-84dd-80e7627afab1}");
...
user_pref("browser.startup.lastColdStartupCheck", 1774381212);
...
user_pref("captchadetection.lastSubmission", 1774370);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIvnFAykvMC0BAgXZaE2CQl8lA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"500fb702-8c1e-4365-826d-48367c7fdd1b\",\"pictureinpicture@mozilla.org\":\"6d23f534-b963-4b51-b2e5-005c72618db2\",\"screenshots@mozilla.org\":\"477b4998-5b7d-4220-8630-5942ce017b75\",\"webcompat@mozilla.org\":\"5c77acf1-65ab-40db-a178-64f2501196a5\",\"firefox-compact-dark@mozilla.org\":\"ba32a697-19aa-4e9a-adde-6479d8bfd622\",\"addons-search-detection@mozilla.com\":\"f2cc874b-5c6e-4805-8734-9d3cbbe108d8\",\"uBlock0@raymondhill.net\":\"673bcc66-085a-432a-aa37-233060ff4d39\"}");
...
user_pref("media.gmp-manager.lastCheck", 1774370282);
user_pref("media.gmp-manager.lastEmptyCheck", 1774370282);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECKB7s115VJ9KBAjBYPgLabjOAw==");
user_pref("toolkit.startup.last_success", 1774380479);
